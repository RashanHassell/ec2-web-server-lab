This lab demonstrates how to launch an Amazon EC2 instance, install Apache (httpd), and host a simple HTML web page. It's part of my AWS Solutions Architect Associate hands-on learning path.
